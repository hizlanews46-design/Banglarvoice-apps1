    ...
    <div className="lg:col-span-1 space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
        ...
        <div className="space-y-3">
          <p className="text-xs text-gray-700 font-medium leading-relaxed">আপনি কি মনে করেন কৃত্রিম বুদ্ধিমত্তা (AI) প্রযুক্তি ব্যবহারের ফলে সংবাদমাধ্যমের নিরপেক্ষতা বৃদ্ধি পাবে?</p>
          <div className="space-y-2 pt-1">
            <button className="w-full text-left bg-gray-50 hover:bg-gray-100 text-xs text-gray-800 px-3 py-2.5 rounded-lg border border-gray-200/60 font-medium transition-colors flex justify-between"><span>হ্যাঁ (Yes)</span><span className="text-gray-400">62%</span></button>
            <button className="w-full text-left bg-gray-50 hover:bg-gray-100 text-xs text-gray-800 px-3 py-2.5 rounded-lg border border-gray-200/60 font-medium transition-colors flex justify-between"><span>না (No)</span><span className="text-gray-400">29%</span></button>
            <button className="w-full text-left bg-gray-50 hover:bg-gray-100 text-xs text-gray-800 px-3 py-2.5 rounded-lg border border-gray-200/60 font-medium transition-colors flex justify-between"><span>মন্তব্য নেই (No Comment)</span><span className="text-gray-400">9%</span></button>
          </div>
        </div>
      </div>
    </div>
